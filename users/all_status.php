                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2" id="table_list">
                                        ...
                                        <tbody>
                                            <?php
                                                $user_to_verify = $db->select("SELECT *, CONCAT(last_name, ', ', first_name ) fullname ,
                                                    (select name from shops where shop_id = shop_id limit 1) name
                                                    FROM form_booking_user 
                                                    inner join personal_info USING (p_info_id)
                                                    where  p_info_id in (select p_info_id from personal_info where user_id = ? ) " , array($_SESSION["user_id"]) );
