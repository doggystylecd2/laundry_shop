                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">On Going Transaction</li>
                                    </ul>
                                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive table-responsive-data2">
                            <table class="table table-data2">
                                ...
                                <tbody>
                                <?php
                                    $parcel = $db->select("SELECT * FROM parcel_details where user_id = ? and `status` not in (1,10,11,12,7) order by created_at desc", array($_SESSION["user_id"]));
                                    if(count($parcel) > 0){
