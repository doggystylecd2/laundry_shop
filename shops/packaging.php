                                        ...
                                        <tbody>
                                             <?php
                                                $user_to_verify = $db->select("SELECT *, CONCAT(last_name, ', ', first_name ) fullname FROM form_booking_user 
                                                    ...
                                                    where status_booking = 8 and shop_id in (select shop_id from shops where p_info_id = (select p_info_id from personal_info where user_id = ?) ) " , array($_SESSION["user_id"]) );
        ...
        <div class="modal-content">
            ...
            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal add_booking">
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-primary" value="Ready To Delivered" />
                </div>
            </form>
...
<script>
    ...
    $(document).ready(() => {
        ...
        $(".add_booking").on("submit",(e) => {
            ...
            $.ajax({
                url : "api/controller/shops/updatetoReady.php",
                method: "post",
                data : data,
                success: (res) => {
                    console.log(res)
