...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if(isset($booking_id) )      {
        ...
        $db->Update("update form_booking_user set `status_booking` =  ? WHERE `booking_id` = ? ", array(7, $booking_id)  );
        ...
        // notify courier
        $description = "Your Order # ".$booking_id.", are now in-process. Have a nice day!. ".date('y-m-d h:m:s');
