...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if(isset($booking_id) )      {
        ...
        $db->Update("update form_booking_user set `status_booking` =  ? WHERE `booking_id` = ? ", array(8, $booking_id)  );
        ...
        // notify clients
        $description = "Your Order # ".$booking_id.", Are ready to pakaging. Have a nice day!. ".date('y-m-d h:m:s');
