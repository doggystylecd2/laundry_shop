...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
	...
	if(isset($shop_id) && isset($select_services) && isset($date_time_to_pickup) && isset($address_to_picup) && isset($contact_no))	    {
		...
		$get_p_info_id = $db->Insert("INSERT INTO form_booking_user (`p_info_id`,`shop_id`,`shop_services_id`,`date_time_to_pickup`,`address`,`contact_no`,`delivery_address`) VALUES (?,?,?,?,?,?,?)", [
