...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if(isset($booking_id) )      {
        ...
        $db->Update("update form_booking_user set `status_booking` =  ? WHERE `booking_id` = ? ", array(6, $booking_id)  );
        ...
        $description = "Order # ".$booking_id.", Arrived at Destination.. Have a nice day!. ".date('y-m-d h:m:s');
