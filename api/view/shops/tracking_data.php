                            ...
                            <table class="table table-top-campaign">
                                <tbody>
                                    <tr>
                                     ...
                                     <?php 
                                        $shops_services_available = $db->Select("SELECT * from booking_transaction 
                                            inner join shops_services_available using(shop_available_id)
                                            where booking_id = ?", array($data["booking_id"]));
                                         $option = '';
