                ...
                <div class="header-button2">
                    ...
                    <div class="account-wrap">
                        <div class="account-item clearfix js-item-menu">
                            <div class="image">
                                <img src="images/icon/avatar-01.jpg" alt="<?php echo $users_details["username"];  ?>" />
                            </div>
                            <div class="content">
                                <a class="js-acc-btn" href="#"><?php echo $users_details["username"];  ?></a>
                            </div>
                            <div class="account-dropdown js-dropdown">
                                <div class="info clearfix">
                                    ...
                                    <div class="content">
                                        ...
                                        <span class="email"><?php echo $users_details["email"];  ?></span>
                                    </div>
                                </div>
