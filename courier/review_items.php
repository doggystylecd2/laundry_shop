            ...
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5">Review Items</h3>
                                        ...
                                        <tbody>
                                            <?php
                                                $user_to_verify = $db->select("SELECT *, CONCAT(last_name, ', ', first_name ) fullname FROM form_booking_user fb
                                                    ...
                                                    where fb.status_booking = 4 and  fb.user_id = ? " , array($_SESSION["user_id"]) );
        ...
        <div class="modal-content">
            ...
            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal add_booking">
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-primary" value="Item COllected" />
...
<script>
    ...
    //    $('#scrollmodal').toggle();
        ...
        $('#pacel_no').append('<span id="parcel_no_value">Details</span>');
          $.post(
            "api/view/driver/review_items.php",
    ...
    $(document).ready(() => {
        ...
        $(".add_booking").on("submit",(e) => {
            ...
            $.ajax({
                url : "api/controller/driver/updateTOCollect.php",
                method: "post",
                data : data,
                success: (res) => {
                    console.log(res)
