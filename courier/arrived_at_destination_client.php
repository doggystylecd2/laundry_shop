            ...
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5">Arrived At Destination - (Client)</h3>
                                        ...
                                        <tbody>
                                            <?php
                                                $user_to_verify = $db->select("SELECT *, CONCAT(last_name, ', ', first_name ) fullname FROM form_booking_user fb
                                                    ...
                                                    where fb.status_booking = 11 and  fb.user_id = ? " , array($_SESSION["user_id"]) );
...
<script>
    ...
    $(document).ready(() => {
        ...
        $(".add_booking").on("submit",(e) => {
            ...
            $.ajax({
                url : "api/controller/driver/updateTODelivered.php",
                method: "post",
                data : data,
                success: (res) => {
                    console.log(res)
