               ...
               <div class="row setup-content" id="step-4">
                 <div class="col-xs-12">
                   <div class="col-md-12">
                     <h3> Step 4</h3>
                     <div class="form-group">
                       <label class="control-label">Upload Resume : Supported File extension (docx, pdf,doc,rtf)</label>
                       <input  required="required" class="form-control" type="file" id="file-input" name="file-input">
                     </div>
                     <div class="form-group">
                       <label class="control-label">Upload Driver License : Supported File extension (jpeg, png,jpg)</label>
                       <input  required="required" class="form-control" type="file" id="file-driver_license" name="file-driver_license">
                     </div>
                     <div class="form-group">
                       <label class="control-label">Tell me about yourself.</label>
                       <textarea name="textarea-input" id="textarea-input" rows="9" placeholder="Content..."  class="form-control" required="required"></textarea>
                     </div>
                     <?php echo $message; ?>
                     <button class="btn btn-primary prevBtn btn-lg pull-left" type="button">Back</button>
                     <input class="btn btn-primary  btn-lg pull-right" type="submit" name="driver_register" value="submit" />
                   </div>
                 </div>
               </div>
